...
export abstract class Change {
    ...
    abstract apply(uuidMap: Record<string, entity.Entity>): boolean;
...
export class ChangeSet extends Change {
    ...
    apply(uuidMap: Record<string, entity.Entity>): boolean {
...
export class ChangeAdd extends Change {
    ...
    apply(uuidMap: Record<string, entity.Entity>): boolean {
        if (uuidMap[(this.object as entity.Entity).id]) {
            return false;
        }
        let a: entity.Entity[] | undefined = (uuidMap[this.subject] as any)[this.property];
        if (a === undefined) {
...
export class ChangeDel extends Change {
    ...
    apply(uuidMap: Record<string, entity.Entity>): boolean {
        const a: entity.Entity[] | undefined = (uuidMap[this.subject] as any)[this.property];
        if (a === undefined) {
            return false;
        }
...
export abstract class Build {
    ...
    constructor(options: {
        ...
        this.name = options.name ?? "";
        this.loadedSystemVersion = options.loadedSystemVersion ?? this.systemVersion();
